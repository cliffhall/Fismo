...
_Yo dawg, we heard you like machines, so we put this machine in our state machine docs._ It represents the machine that you will clone and install your own machines into. Incidentally, It was created by a machine using [Midjourney](https://twitter.com/midjourney).
